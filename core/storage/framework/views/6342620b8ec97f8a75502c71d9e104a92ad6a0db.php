...
<div class="overview-wrapper">
  ...
  <a tabindex="0" class="floating-btn" role="button" data-toggle="popover" data-trigger="focus" title="What to do next" data-content="Next thing to do after Depositing using any of our methods provided is to head over to My investments are subscribe to a plan ">
        ...
        <div class="card-body">
          ...
          <div class="flex-wrap pt-4 pb-2 d-flex justify-content-around">
            <div class="px-2 pb-2 text-center pb-md-0">
              ...
              <h6 class="mt-3 mb-0 fw-bold"><?php echo e(__('Investments')); ?></h6>
            </div>

            <div class="px-2 pb-2 text-center pb-md-0">
              <div id="circles-2"></div>
              <h6 class="mt-3 mb-0 fw-bold"><?php echo e(__('Withdrawals')); ?></h6>
            </div>
            <div class="px-2 pb-2 text-center pb-md-0">
              <div id="circles-3"></div>
              <h6 class="mt-3 mb-0 fw-bold"><?php echo e(__('Downlines')); ?></h6>
            </div>
          </div>
        </div>
      </div>
...
</div><?php /**PATH /home/v2.tradepander.com/public_html/core/resources/views/user/atlantis/overview.blade.php ENDPATH**/ ?>