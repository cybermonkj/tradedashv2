                ...
                <div class="col-md-4">   
                        <div class="card ">
                            <div class="card-header">
                                <div align="center">
                                    <h3 class="colhd"><i class="fa fa-key"></i><?php echo e(__(' Enter OTP')); ?> </h3>
                                </div>
                            </div>
...
<?php echo $__env->make('inc.auth_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/v2.tradepander.com/public_html/core/resources/views/user/enter_otp.blade.php ENDPATH**/ ?>