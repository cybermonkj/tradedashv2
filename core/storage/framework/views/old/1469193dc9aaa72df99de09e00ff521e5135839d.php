                            ...
                            <div class="card-custom">
                                <div class="card-custom__header">
                                    <div class="section">
                                        ...
                                        <?php if($inv->package_name == "Gold"): ?>
                                            <div class="media--gold"></div>
                                        <?php endif; ?>
                                        
                                        
                                        <?php if($inv->package_name == "Family"): ?>
                                            <div class="media--brown"></div>
                                        <?php endif; ?>

                                        <?php if($inv->package_name == "Premium"): ?>
                                            <div class="media--grey"></div>
                                        <?php endif; ?>

                                        <?php if($inv->package_name == "Master"): ?>
                                            <div class="media--master"></div>
                                        <?php endif; ?>
                                            
                                        <?php if($inv->package_name <> "Rush" && $inv->package_name <> "Gold" && $inv->package_name <> "Family" && $inv->package_name <> "Premium" && $inv->package_name <> "Master"): ?>
                                            <div class="media"></div>
                                        <?php endif; ?>
                                        <div class="group">
