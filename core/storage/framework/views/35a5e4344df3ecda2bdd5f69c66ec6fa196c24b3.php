	<div class="wrapper">
						...
						<li class="nav-item dropdown hidden-caret">
							...
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									...
									<li>
										<div class="dropdown-divider"></div>										
										<a class="dropdown-item" href="/<?php echo e($user->username); ?>/dashboard"><span class="fa fa-desktop"></span> &nbsp;Overview</a>
		...
		<!-- End Sidebar --><?php /**PATH /home/v2.tradepander.com/public_html/core/resources/views/layouts/atlantis/header.blade.php ENDPATH**/ ?>