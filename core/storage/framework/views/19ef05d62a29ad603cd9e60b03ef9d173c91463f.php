                      ...
                      <form id="settings_form" action="/admin/update/site/settings" method="post">
                       ...
                       <!-- <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="row margin_top50 mb-5"> 
                          <div   class="col-md-12">
                            <button class="btn btn-info float-right"  onclick="load_post_ajax('/admin/update/site/settings', 'settings_form', 'admin_settings_form' )" > <?php echo e(__('Update Tradepander')); ?> </button>
                          </div>                                     
                        </div>
...
<?php echo $__env->make('admin.atlantis.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/v2.tradepander.com/public_html/core/resources/views/admin/settings.blade.php ENDPATH**/ ?>