                                   ...
                                   <form id="add_new_pack" action="/admin/create/package" method="post" >
                                       @csrf()
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                <label for="package_name">{{ __('Name') }}</label>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                <label for="daily_interest">{{ __('Interest Rate (%)') }}</label>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-6">
                                                <label for="period">{{ __('Investment Period(Days)') }}</label>
                                             ...
                                             <div class="col-sm-6">
                                                <label for="interval" class="">{{ __('Maturity Time (Days)') }}</label>
