...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 10, 2020 at 04:20 PM
...
CREATE TABLE IF NOT EXISTS `coinpayment_transactions` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `coinpayment_transactions_txn_id_unique` (`txn_id`)
...
DROP TABLE IF EXISTS `cp_cp_log`;
CREATE TABLE IF NOT EXISTS `cp_cp_log` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `cp_cp_transactions`;
CREATE TABLE IF NOT EXISTS `cp_cp_transactions` (
...
DROP TABLE IF EXISTS `mread`;
CREATE TABLE IF NOT EXISTS `mread` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `ref_set`;
CREATE TABLE IF NOT EXISTS `ref_set` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `states` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=4122 DEFAULT CHARSET=latin1;
