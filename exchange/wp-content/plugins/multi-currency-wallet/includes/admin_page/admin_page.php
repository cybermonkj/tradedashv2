						...
						<tbody>
							<tr>
								...
								<td>
									...
									<input name="btc_fee" type="text" value="<?php echo esc_attr( get_option('btc_fee') );?>" class="tiny-text textright" disabled> %, no less than <input name="btc_min" type="text" value="<?php echo esc_attr( get_option('btc_min') );?>" size="7" class="textright" placeholder="0.001" disabled> <?php esc_html_e( 'BTC', 'multi-currency-wallet' ); ?>
								</td>
							</tr>
							<tr>
								<th scope="row">
								...
								<td>
									<input name="btc_fee_address" type="text" class="regular-text" value="<?php echo esc_attr( get_option('btc_fee_address') );?>" disabled>
								</td>
							</tr>
							<tr>
								<th scope="row">
								...
								<td>
									<input name="eth_fee" type="text" value="<?php echo esc_attr( get_option('eth_fee') );?>" class="tiny-text textright" disabled> %, no less than <input name="eth_min" type="text" value="<?php echo esc_attr( get_option('eth_min') );?>" size="7" class="textright" placeholder="0.001" disabled> <?php esc_html_e( 'ETH', 'multi-currency-wallet' ); ?>
								</td>
							</tr>
							<tr>
								<th scope="row">
								...
								<td>
									<input name="eth_fee_address" type="text" class="regular-text" value="<?php echo esc_attr( get_option('eth_fee_address') );?>" disabled>
								</td>
							</tr>
							<tr>
								<th scope="row">
								...
								<td>
									<input name="tokens_fee" type="text" value="<?php echo esc_attr( get_option('tokens_fee') );?>" class="tiny-text textright" disabled> %, no less than <input name="tokens_min" type="text" value="<?php echo esc_attr( get_option('tokens_min') );?>" size="7" class="textright" placeholder="0.001" disabled> <?php esc_html_e( 'Tokens', 'multi-currency-wallet' ); ?>
								</td>
							</tr>
							<tr>
								<th scope="row">
